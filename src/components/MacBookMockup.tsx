...
export default function MacBookMockup({ youtubeVideoId }: MacBookMockupProps) {
  return (
    <>
      <style jsx>{`
        .mbp-mockup-wrapper {
        ...
        .mbp-shadow .shadow-left {
          ...
          top: 10%;
          z-index: 90;
          background: linear-gradient(180deg, rgba(0, 0, 0, 1) 0%, rgba(8, 11, 17, 0.85) 2.5%, rgba(29, 32, 36, 0.4) 15%, rgba(255, 255, 255, 0) 50%);
          filter: blur(2px);
