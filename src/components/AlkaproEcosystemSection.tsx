...
const AlkaproEcosystemSection = () => {
  ...
  useEffect(() => {
    ...
    <div className="relative py-24 bg-gradient-to-b from-white via-gray-50 to-slate-100 overflow-hidden">
      ...
      <div className="absolute -bottom-10 -right-10 md:-bottom-16 md:-right-16 lg:-bottom-20 lg:-right-20 w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 opacity-60 pointer-events-none z-0">
        <DotLottieReact
          src="https://lottie.host/fe0ddddd-8c8e-4e5c-aa77-404d423f7fdd/qs5A75z8pV.lottie"
          loop
          autoplay
        />
      </div>
